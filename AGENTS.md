...
This project is indexed by GitNexus as **opencode-workflow** (704 symbols, 728 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/opencode-workflow/context` | Codebase overview, check index freshness |
| `gitnexus://repo/opencode-workflow/clusters` | All functional areas |
| `gitnexus://repo/opencode-workflow/processes` | All execution flows |
| `gitnexus://repo/opencode-workflow/process/{name}` | Step-by-step execution trace |
